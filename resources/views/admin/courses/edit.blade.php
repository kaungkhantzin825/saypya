...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Course: {{ $course->title }}</h1>
            </div>
            <div class="col-sm-6">
                                ...
                                <div id="what-you-learn-container">
                                    @if($course->what_you_learn)
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control" name="what_you_learn[]" value="{{ $item }}">
                            ...
                            <div class="form-group">
                                ...
                                <div id="requirements-container">
                                    @if($course->requirements)
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control" name="requirements[]" value="{{ $item }}">
                                            <div class="input-group-append">
                                                <button type="button" class="btn btn-danger remove-field"><i class="fas fa-minus"></i></button>
                                            </div>
                                        </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                @if($course->thumbnail)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($course->thumbnail) }}" alt="Current thumbnail" class="img-thumbnail" style="max-height: 150px;">
                                </div>
                                @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('preview_video') is-invalid @enderror" id="preview_video" name="preview_video" value="{{ old('preview_video', $course->preview_video) }}" placeholder="https://youtube.com/...">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('admin.courses.content', $course) }}" class="btn btn-info btn-block">Manage Content</a>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-field', function() {
        ...
        let placeholder = container.find('input').first().attr('placeholder') || 'Enter value';
        container.append(`
            <div class="input-group mb-2">
