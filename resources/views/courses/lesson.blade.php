            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-0">
                    ...
                    <div class="aspect-video bg-gray-900 flex items-center justify-center">
                        @if($lesson->video_url)
                            @if($lesson->isYoutubeUrl($lesson->video_url))
                                ...
                                <iframe id="lesson-video" class="w-full h-full" src="{{ $lesson->youtube_embed_url }}"
                                    frameborder="0"
                    ...
                    <div class="bg-white p-6 border-b">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            ...
                            <div class="flex-shrink-0">
                                @if($alreadyDone)
                                    <span id="done-badge" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm
                                ...
                                @else
                                    <button id="mark-done-btn" onclick="markLessonComplete({{ $lesson->id }})" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm
                ...
                <div class="lg:col-span-1 bg-white border-l border-gray-200 max-h-screen overflow-y-auto">
                    <div class="p-4 border-b border-gray-200">
                        <h2 class="font-semibold text-gray-900 mb-2 myanmar-text">သင်ခန်းစာအကြောင်းအရာ2</h2>
